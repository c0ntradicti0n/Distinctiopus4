...
from difference_predictor.word_splitter import CustomSpacyWordSplitter


@Predictor.register('versatile-sentence-tagger')
class MoreVersatileTaggerPredictor(Predictor):
    """
    ...
    def __init__(self, model: Model, dataset_reader: DatasetReader, language: str = 'en_core_web_sm') -> None:
        ...
        self._tokenizer = CustomSpacyWordSplitter(language=language, pos_tags=True)

    def predict_string(self, sentence: str) -> JsonDict:
        return self.predict_json({"sentence" : sentence})

    def predict_tokens(self, tokens: str) -> JsonDict:
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        ...
        elif "tokens" in json_dict:
            pretokens = json_dict["tokens"]
            tokens = self._tokenizer.split_pretokenized_words(pretokens)
